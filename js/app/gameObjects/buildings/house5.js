define(function (require) {
    ...
    function Building() {
        ...
        renderer.setSprite(vkaria.sprites.getSprite("buildings/house5-1.png"));
        renderer.setPivot(32,35);
        g0.addComponent(renderer);

        //g1
        var renderer = this.sprite = new engine.SpriteRenderer();
        renderer.layer = vkaria.layers.buildingsLayer;
        renderer.setSprite(vkaria.sprites.getSprite("buildings/house5-2.png"));
